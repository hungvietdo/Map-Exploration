...
//
//
//    if (checkBoundary(frontPos) && (BallExploration[frontPos.horizontal][frontPos.vertical]==-1) ) //Not check yet
//            {
...
//
//
//           if ((travelPath[v_h][v_v+1] == travelPath[v_h][v_v]-1) && (v_v+1 <= ChessBoardWidth))
//           {
//                travelPos.vertical++;
//                continue;
//           }
//
//            if ((travelPath[v_h][v_v-1] == travelPath[v_h][v_v]-1) && (v_v-1 > 0))
//            {
//                travelPos.vertical--;
//                continue;
//            }
//
//            if ((travelPath[v_h+1][v_v] == travelPath[v_h][v_v]-1)&& (v_h+1 <= ChessBoardWidth))
//            {
//                 travelPos.horizontal++;
//                 continue;
//            }
//
//            if ((travelPath[v_h-1][v_v] == travelPath[v_h][v_v]-1) && (v_h-1 > 0))
//            {
//                  travelPos.horizontal--;
//                  continue;
//            }
